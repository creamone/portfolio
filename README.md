...
> - 핵심역할 : CRUD를 통해 여행 장소 추가 및 수정 삭제 기능 구현 및 docker를 통한 서버 배포 경험
> - Language : python3  
...
> - 핵심 역할 : Serializer를 통해 filter를 사용하여 추천 페이지에 브랜드별 혹은 색깔별 리스트 표기 구현
> - Language : python3
...
> - 핵심 역할 :  csrf를 통해 로그인/회원가입/회원 수정/회원 탈퇴 구현
